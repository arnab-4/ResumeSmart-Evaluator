...
with st.sidebar.container():
    st.markdown('<div class="sidebar-title">ResumeSmart Evaluator</div>', unsafe_allow_html=True)
...
with st.container():
    ...
    # Placeholder image
    with col2:
        st.image("Jobmatch-analyzer.jpg", use_column_width=True)
...
<div class="footer" id="footer">
  <p>&copy; 2024 ResumeSmart Evaluator. All rights reserved. | Developed by <a href="https://www.linkedin.com/in/arnab-manna-442586240/">Arnab Manna</a></p>
</div>
""", unsafe_allow_html=True)
